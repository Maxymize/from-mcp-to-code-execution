...
## CRITICAL: Skill File Structure

**A skill folder MUST contain ONLY essential files:**

```
.claude/skills/<name>-code-exec/
├── SKILL.md                    # REQUIRED - Instructions for Claude
└── scripts/
    └── client-<type>.ts        # REQUIRED - TypeScript client
```

**DO NOT CREATE any of these files inside the skill folder:**
- README.md (redundant with SKILL.md)
- COVERAGE.md (process documentation, not functional)
- MIGRATION_VISUAL.md (informational, not functional)
- CHANGELOG.md
- INSTALLATION_GUIDE.md
- Any other auxiliary documentation

The skill must contain ONLY what Claude needs to execute the skill. Process documentation, migration reports, and visual diagrams are NOT part of the skill and must NOT be created.
